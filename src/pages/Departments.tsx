...
import { Users, BookOpen, Award, GraduationCap, Building2 } from "lucide-react";
  ...
  const departments = [
    {
      ...
      description: "Civil Engineering department focuses on design, construction and maintenance of infrastructure projects with emphasis on sustainable development.",
      established: "2005",
      faculty: 12,
      laboratories: 8,
    ...
    },
    {
      ...
      description: "Mechanical Engineering department offers a blend of core mechanical principles with modern automation and manufacturing techniques.",
      established: "2001",
      faculty: 15,
      laboratories: 10,
      courses: ["B.Tech in Mechanical Engineering", "M.Tech in CAD/CAM"],
      hod: "Dr. Prashant Deshmukh"
    },
    {
      id: "computer",
      name: "Computer Science & Engineering",
      icon: <BookOpen className="h-12 w-12 text-blue-700" />,
      description: "Computer Science department provides cutting-edge education in software development, algorithms, and computer systems.",
      established: "2003",
      faculty: 18,
      laboratories: 6,
    ...
    },
    {
      ...
      description: "Artificial Intelligence and Machine Learning specialization focuses on intelligent systems, data science, and advanced computing.",
      established: "2018",
      faculty: 10,
      laboratories: 4,
        ...
        <div className="mt-16">
          <Tabs defaultValue="civil">
            <TabsList className="grid w-full grid-cols-2 md:grid-cols-4">
              ...
              <TabsTrigger value="aiml">CSE (AI & ML)</TabsTrigger>
            </TabsList>
                ...
                <div className="grid md:grid-cols-3 gap-8">
                  <div className="col-span-2">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="grid md:grid-cols-2 gap-4">
                          {Array.from({ length: 4 }).map((_, index) => (
                            <div key={index} className="bg-white p-4 rounded-lg shadow-sm">
                              <h4 className="font-medium text-blue-700">{dept.name} Lab {index + 1}</h4>
                              <p className="text-gray-600 text-sm mt-1">Advanced equipment and tools for practical learning.</p>
                            </div>
                          ))}
                        </div>
                      </div>
                      ...
                      <div>
                        <h3 className="text-xl font-semibold text-blue-800 mb-3">Research Areas</h3>
                        <ul className="list-disc list-inside space-y-1 text-gray-700">
                          <li>Advanced Materials and Structures</li>
                    ...
                    <Card className="sticky top-24">
                      ...
                      <CardContent className="space-y-4">
                        <div className="flex items-center gap-4 p-3 bg-gray-50 rounded-lg">
                          ...
                          <div>
                            <h4 className="font-medium">{dept.hod}</h4>
                            <p className="text-sm text-gray-600">HOD, Professor</p>
                          </div>
                        </div>
                        ...
                        {Array.from({ length: 3 }).map((_, index) => (
                          <div key={index} className="flex items-center gap-4 p-3 rounded-lg">
                            ...
                            <div>
                              <h4 className="font-medium">Faculty Person</h4>
